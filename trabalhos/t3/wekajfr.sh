...
for ARG in "$@"
do
  if [ "$ARG" = "-memory" ] || [ "$ARG" = "-main" ] || [ "$ARG" = "-no-gui" ] || [ "$ARG" = "-jvm" ] || [ "$ARG" = "-jfr" ]
  then
  	OPTION=$ARG
  	continue
  fi
...
then
    ...
    JFROPT="-XX:StartFlightRecording:$JFR" #-XX:StartFlightRecording:filename=recording.jfr,duration=30s\
fi

#-agentpath:/home/andrea/Downloads/graalvm-ce-java11-22.1.0/lib/visualvm/visualvm/lib/deployed/jdk16/linux-amd64/libprofilerinterface.so=/home/andrea/Downloads/graalvm-ce-java11-22.1.0/lib/visualvm/visualvm/lib,5140
#  -agentpath:/home/andrea/Downloads/visualvm_143/profiler/lib/deployed/jdk16/linux-amd64/libprofilerinterface.so=/home/andrea/Downloads/visualvm_143/profiler/lib,5140 
